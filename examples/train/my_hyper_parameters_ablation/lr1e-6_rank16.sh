...
swift sft \
    ...
    --max_length 2048 \
    --output_dir /fs-computility/ai-shen/kilab-shared/heqianxi/swift/hyper_qwen2.5vl72b_sft_lora_mix/lr1e-6_rank16 \
    --warmup_ratio 0.02 \
    --dataloader_num_workers 8 \
    >/fs-computility/ai-shen/heqianxi/ms-swift/logs/hyper/lr1e-6_rank16.log 2>&1 &